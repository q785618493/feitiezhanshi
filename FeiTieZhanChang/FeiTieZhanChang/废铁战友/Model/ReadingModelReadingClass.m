//
//	ReadingModelReadingClass.m
//	Model file Generated using JSONExport: https://github.com/Ahmed-Ali/JSONExport



#import "ReadingModelReadingClass.h"

@interface ReadingModelReadingClass ()
@end
@implementation ReadingModelReadingClass
...
-(instancetype)initWithDictionary:(NSDictionary *)dictionary
{
	...
	if(![dictionary[@"data"] isKindOfClass:[NSNull class]]){
		self.data = [[ReadingModelData alloc] initWithDictionary:dictionary[@"data"]];
	}
