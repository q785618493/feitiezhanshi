...
#import "BtnStoryCell.h"

@implementation BtnStoryCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        [self addBtnStoryMasonry];
    }
    return self;
}

- (void)addBtnStoryMasonry {
    WS(weakSelf)
...
- (void)setHotModel:(BtnNineList *)hotModel {
    
    _hotModel = hotModel;
    [_titleLabel setText:_hotModel.title];
    [_showImage downloadImage:_hotModel.coverimg];
    [_infoLabel setText:_hotModel.content];
    [_nameLabel setText:_hotModel.name];
    
    if ([_hotModel.coverimg isEmptyString]) {
